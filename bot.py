...
async def exchar(ctx):
    ...
    embed.add_field(name="Fuerza: ", value=personaje.fuerza, inline=True)
    embed.add_field(name="Destreza: ", value=personaje.destreza, inline=True)
    embed.add_field(name="Voluntad: ", value=personaje.voluntad, inline=True)
